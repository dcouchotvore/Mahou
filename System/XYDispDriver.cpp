...
HRESULT XYDispDriver::InvokeMethodV(int nIndex, va_list argList)
{
	...
	if(dispparams.cArgs!=0)
	{
		...
		while(*pb!=0)
		{
			...
			case VT_R4:
				pArg->vt = VT_R4;
				pArg->fltVal = va_arg(argList, double);
				break;
			case VT_R8:
