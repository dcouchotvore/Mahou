...
unsigned char	_stdcall IsInpOutDriverOpen();  //Returns TRUE if the InpOut driver was opened successfully
unsigned char	_stdcall IsXP64Bit();			//Returns TRUE if the OS is 64bit (x64) Windows.
